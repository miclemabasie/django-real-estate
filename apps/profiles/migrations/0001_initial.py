# Generated by Django 3.2.7 on 2023-12-11 15:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(default='+237670181440', max_length=30, region=None, verbose_name='Phone Number')),
                ...
                ('profile_photo', models.ImageField(default='/profile_default.pnp', upload_to='', verbose_name='Profile Photo')),
                ('gender', models.CharField(choices=[('Male', 'Male'), ('Female', 'Female'), ('Other', 'Other')], default='Other', max_length=20, verbose_name='Gender')),
                ('country', django_countries.fields.CountryField(default='CMR', max_length=2, verbose_name='Country')),
                ...
                ('is_seller', models.BooleanField(default=False, help_text='Are you looking to sell a propety?', verbose_name='Seller')),
